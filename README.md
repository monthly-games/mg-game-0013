...
![Arena Legends: Mercenary League gameplay screen](docs/images/gameplay-showcase.png)

**Arena Legends: Mercenary League** centers on the **Battle and Collect** loop. The player enters from the main menu, reads the active objective and pressure state, performs the core action, banks rewards, then returns through roadmap and retention goals.
...
git clone --recursive https://github.com/monthly-games/mg-game-0013.git
