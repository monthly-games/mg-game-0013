...
| 타깃 지역 | KR, SEA |
| Year 2 역할 | PVP/리그 시스템 공통 모듈, Season Pass/랭킹 보상 템플릿 실험 |
...
```bash
git clone --recursive git@github.com:monthly-games/mg-game-0013.git
cd mg-game-0013
...
- [GDD](docs/design/gdd_game_0013.json)
